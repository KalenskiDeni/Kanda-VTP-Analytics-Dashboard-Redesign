...
const allCourses = [
  ...
  {
    title: "GWO BTT Mechanical",
    duration: "2.00 h",
    sessions: 256,
    icon: mechanicalIcon,
  },
  {
    title: "GWO Service Lift User",
    duration: "1.45 h",
    sessions: 123,
    icon: liftIcon,
  },
  {
    title: "GWO Slinger Signaller",
    duration: "1.25 h",
    sessions: 765,
    icon: slingerIcon,
  },
  {
    title: "Onboarding to Offshore",
    duration: "3.00 h",
    sessions: 156,
    icon: offshoreIcon,
  },
