...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onValue(postsRef, (snapshot) => {
      if (snapshot.exists()) {
        ...
        console.warn("No posts found in Firebase.");
        setPosts([]);
      }
  ...
  return (
    <div className={`analytics-page ${isSliding ? "slide-out" : "slide-in"}`}>
      ...
      {showDatePicker && (
        <div ref={datePickerRef} className="date-picker-popup">
          <DatePicker
            selected={null}
            onChange={() => {}}
      ...
      <section className="score-section">
        <div className="score-ring-wrapper">
          ...
          <div className="score-ring-content">
            <p
              className={
                activeTab === "your" ? "your-tab-text" : "all-tab-text"
              }
            >
            ...
            <span
              className={
                activeTab === "your" ? "your-tab-info" : "all-tab-info"
              }
            >
